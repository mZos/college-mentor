...
import com.example.kipmnotes.adapter.StudyRecyclerAdapter
...
//      Added Divider b/w items
        recyclerStudy.addItemDecoration(
            DividerItemDecoration(
                recyclerStudy.context,(layoutManager as LinearLayoutManager).orientation
            )
        )

        recyclerAdapter = StudyRecyclerAdapter(activity as Context,studyTopicList)
